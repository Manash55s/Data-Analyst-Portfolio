...
select count(*) as count_bill,billing_country 
from invoice
group by billing_country
order by count_bill desc
...
select sum(i.total) as total_spent , c.first_name, c.last_name
from customer as c
...
2. Invite the artists who have written the most rock music in our dataset. Write a
